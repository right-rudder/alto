const multiEngineRatingData = {
  data: {
    siteTitle:
      "Multi-Engine Rating Training in Oklahoma City | Alto Flight Academy",
    siteDescription:
      "Advance your aviation career with multi-engine rating training at Alto Flight Academy in Oklahoma City. Learn to fly twin-engine aircraft with experienced instructors. Professional multi-engine training at Sundance Airport (KHSD) in Yukon, OK.",
    keywords:
      "multi-engine rating oklahoma city, twin engine training oklahoma, multi-engine pilot training oklahoma, multi-engine certification oklahoma, advanced pilot training oklahoma city, commercial pilot training oklahoma, twin engine flight training yukon ok",
